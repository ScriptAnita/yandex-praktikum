...
/* Отлично!:
+ index.js содержит только логику инстанцирования классов и взаимодействия между ними
+ используется слабое связывание
+ нет дублирования кода */

/* Можно лучше:
Будет здорово поработать над однородным форматированием кода: сейчас не везде соблюдается иерархия отступов (например, строки 40,41)
и при импорте переменных используются разные варианты кавычек */
